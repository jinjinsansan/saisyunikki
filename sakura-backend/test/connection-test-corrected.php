...
$dbname = 'blackrabbit685_kanjou_nikki_db';  // 修正
...
?>');
    ...
    echo "<li><strong>🗄️ スキーマ実行</strong><br>テーブル作成SQLを実行</li>";
...
echo "<p>🔧 テストバージョン: Corrected Info v1.0</p>";
