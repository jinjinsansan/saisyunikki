...
echo "<h1>🔧 さくらのサーバー データベース接続テスト（最終版）</h1>";
echo "<hr>";

// 正しい接続情報
$host = 'mysql3108.db.sakura.ne.jp';
$dbname = 'blackrabbit685_kanjou_nikki_db';  // 修正済み
$username = 'blackrabbit685_kanjou_nikki_db'; // 修正済み
$password = '040505Aoi';                      // 修正済み（括弧なし）
$port = 3306;

echo "<h2>📋 接続設定情報（修正版）</h2>";
